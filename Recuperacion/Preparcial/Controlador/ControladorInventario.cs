...
namespace Preparcial.Controlador
{
    public static class ControladorInventario
    {
        ...
        //Correccion: Se cambio el nombre de la variable "nombre", y se puso producto
        public static void AnadirProducto(string producto, string descripcion, string precio, string stock)
        {
            try
            {
                // Correccion Tambien se cambio en VALUES(producto), en vez de nombre
        ...
        //Correccion: Se cambio de id, a idArticulo
